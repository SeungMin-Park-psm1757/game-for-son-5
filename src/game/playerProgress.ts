...
const ARROW_THEMES: ArrowTheme[] = [
  { tip: '#30343f', grip: '#233041', featherA: '#d9485a', featherB: '#f0b13c', featherC: '#2f8f83' },
  { tip: '#8b5e3c', grip: '#7b4a28', featherA: '#f97316', featherB: '#facc15', featherC: '#166534' },
  { tip: '#0f766e', grip: '#115e59', featherA: '#34d399', featherB: '#fde68a', featherC: '#0f766e' },
  { tip: '#2563eb', grip: '#1d4ed8', featherA: '#60a5fa', featherB: '#93c5fd', featherC: '#f8fafc' },
  { tip: '#d97706', grip: '#b45309', featherA: '#f59e0b', featherB: '#fcd34d', featherC: '#fef3c7' },
  { tip: '#dc2626', grip: '#991b1b', featherA: '#fb7185', featherB: '#fdba74', featherC: '#fde68a' },
];
